...
from pyhub.mcptools.excel.tasks.sheets import get_opened_workbooks, find_data_ranges
...
@mcp.tool(delegator=get_opened_workbooks, timeout=10)
async def excel_get_opened_workbooks():
    pass


@mcp.tool(delegator=find_data_ranges, timeout=5)
