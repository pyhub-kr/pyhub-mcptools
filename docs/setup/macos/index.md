...
!!! info "알파/특정 버전 설치"
    ...
    **최신 알파 버전 설치:**
    ```bash
    bash <(curl -fsSL https://raw.githubusercontent.com/pyhub-kr/pyhub-mcptools/refs/heads/main/scripts/install.sh) --alpha
    ```

    **특정 버전 설치:**
    ```bash
    bash <(curl -fsSL https://raw.githubusercontent.com/pyhub-kr/pyhub-mcptools/refs/heads/main/scripts/install.sh) --version v0.9.6
    ```
...
./pyhub.mcptools tools-call excel_set_values sheet_range="A34" values='val1,val2,val3\nval4,val5,val6'
```
